 ...
 */
class StateVertexUrlEqualityImpl implements StateVertex {
	 ...
	 */
	@VisibleForTesting
	StateVertexUrlEqualityImpl(int id, String name, String dom) {
	 ...
	 */
	public StateVertexUrlEqualityImpl(int id, String url, String name, String dom, String strippedDom) {
		this.id = id;
		this.url = url;
		this.name = name;
		this.dom = dom;
	...
	public boolean equals(Object object) {
		if (object instanceof StateVertex) {
			...
			return Objects.equal(this.url, that.getUrl());
		}
		return false;
	}
